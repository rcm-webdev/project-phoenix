...
const icons = {
    ...
    arrows: '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 3v6m-7 9l-3 3l-3-3m3 3V3m13 3l-3-3l-3 3m3 15v-2m0-4v-2"/>',
    packages:
        '<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m7 16.5l-5-3l5-3l5 3V19l-5 3z"/><path d="M2 13.5V19l5 3m0-5.455l5-3.03m5 2.985l-5-3l5-3l5 3V19l-5 3zM12 19l5 3m0-5.5l5-3m-10 0V8L7 5l5-3l5 3v5.5M7 5.03v5.455M12 8l5-3"/></g>',
} as const;

type IconName = keyof typeof icons;

const listLinks: { label: string; href: string; icon: IconName }[] = [
    { label: 'Dashboard', href: '/', icon: 'dashboard' },
    { label: 'Items', href: '/items', icon: 'packages' },
...
<template>
    <div class="flex h-screen">
        <div class="flex w-64 flex-col gap-5 bg-neutral-950 font-bold text-white">
            <img class="mt-10 w-44 self-center" src="/images/clinicops.svg" alt="logo" />
            <Link
                v-for="link in listLinks"
                :key="link.href"
                :href="link.href"
                class="mx-5 flex items-center gap-3 rounded-2xl p-4 text-lg text-gray-400 transition-colors hover:bg-neutral-800 hover:text-white"
            >
                <svg
            ...
            <div class="flex flex-col gap-80">
                <div class="w-full justify-between border-t-2 border-neutral-800"></div>
                <div class="mx-5 text-neutral-700">
